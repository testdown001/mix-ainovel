...
class PersonaPayload(BaseModel):
    ...
    sentence_rhythm: Optional[str] = None
    vocabulary_preferences: Optional[List[str]] = None
    unique_expressions: Optional[List[str]] = None
    formality_level: Optional[str] = None
    opening_style: Optional[str] = None
    transition_style: Optional[str] = None
    ending_style: Optional[str] = None
    pacing_style: Optional[str] = None
    emotional_tone: Optional[str] = None
    dialogue_style: Optional[str] = None
    dialogue_tags: Optional[str] = None
    description_style: Optional[str] = None
    show_vs_tell_ratio: Optional[str] = None
    sensory_focus: Optional[List[str]] = None
    physiological_reactions: Optional[List[str]] = None
    benchmark_texts: Optional[List[str]] = None
    catchphrases: Optional[List[str]] = None
    personal_quirks: Optional[List[str]] = None
    imperfection_patterns: Optional[List[str]] = None
    thinking_pauses: Optional[List[str]] = None
    filler_words: Optional[List[str]] = None
    regional_expressions: Optional[List[str]] = None
