...
- [ ] **金手指 (Golden Finger/Cheat):** 主角的特殊能力、系统、未来知识、逆天机缘等核心优势。包括金手指的类型、表现形式、限制条件和成长路线。（仅适用于奇幻/玄幻/异能/系统流/都市/重生等题材；纯文学/现实主义等题材可标记为“不适用”并跳过）
...
4.  **Golden Finger Guidance (金手指导引) — 有条件触发：**
    *   **触发条件：** 当已收集「类型与基调」且属于奇幻/玄幻/修仙/都市异能/系统流/重生/穿越/末世/游戏等题材时，在收集完「核心冲突」后提问金手指。
    *   **跳过条件：** 若题材为纯文学/现实主义/悬疑推理/历史/言情（无异能元素）等，直接将金手指标记为“不适用”并跳过。
    *   **提问示例：**
        *   *AI Says:* "好的，我们已经知道主角要面对什么了。现在来聊聊最关键的——他/她凭什么在这个世界里活下去，甚至翻盘？每个牛逼的主角都有一张底牌，你的主角的金手指是什么？
            A) **系统流**：获得某种面板系统（任务/商店/属性/抽卡），通过完成任务获得奖励和提升。
            B) **重生知识**：重生回到过去，携带未来记忆/技能/信息，利用先知先觉逆天改命。
            C) **特殊能力**：拥有某种独一无二的天赋（如吹灭灯火的死神之眼、感知危险的第六感、复制他人能力等）。
            D) **神器/传承**：获得一件强大的神器或某位大佬的传承，器物会随主角成长而解锁新能力。
            E) **血脉/体质**：觉醒了特殊血脉（如龙血、魔神后裔），拥有异于常人的体质和天赋。
            F) **空间/秘境**：拥有一个私人空间（修炼加速/种植灵药/时间流速不同），作为核心培养基地。
            G) **双生/多生**：拥有多个身体或分身，可以同时进行多线操作。
            H) **其他类型**：以上都不是我想要的，我有自己的想法。
            请选择一个，或自由描述你的想法。"
    *   **追问策略：** 用户选择金手指类型后，可追问一个“限制条件”问题（如“这个能力有什么副作用或使用代价？”），帮助建立金手指的平衡性。这不是必须的——如果用户的回答已经包含了限制信息，直接跳过。
