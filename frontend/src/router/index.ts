...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/novel/:id/plot-lab',
      name: 'plot-lab',
      component: () => import('../views/PlotLabView.vue'),
      props: true,
      meta: { requiresAuth: true },
    },
    {
      path: '/novel/:id/continuous-gen',
      name: 'continuous-gen',
      component: () => import('../views/ContinuousGenView.vue'),
      props: true,
      meta: { requiresAuth: true },
    },
    {
      path: '/novel/:id/timeline',
      name: 'timeline',
    ...
    {
      path: '/inspiration/catalyst',
      name: 'ai-catalyst',
      component: () => import('../views/AICatalystView.vue'),
      meta: { requiresAuth: true },
    },
    {
      path: '/inspiration/mind-map',
      name: 'mind-map',
