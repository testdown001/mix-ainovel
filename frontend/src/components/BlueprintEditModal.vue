      ...
      >
        <div class="md-dialog w-full max-w-2xl mx-4 max-h-[90vh] flex flex-col">
          ...
          <div class="md-dialog-content flex-1 overflow-y-auto py-4">
            <ChapterOutlineEditor v-if="props.field === 'chapter_outline'" v-model="editableContent" :project-id="props.projectId" />
            ...
            <RelationshipsEditor v-else-if="props.field === 'relationships'" v-model="editableContent" :project-id="props.projectId" />
