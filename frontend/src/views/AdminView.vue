      ...
      >
        <div class="sider-header">
          <span class="logo" v-if="!collapsed">
            <span class="logo-accent">✦</span> Octopus AI Novel 管理台
          </span>
...
const components: Record<MenuKey, ReturnType<typeof defineAsyncComponent>> = {
  ...
  skill_management: defineAsyncComponent(() => import('../components/admin/SkillManagement.vue')),
...
const iconRenderers: Record<MenuKey, () => any> = {
  ...
  skill_management: () => h('span', { class: 'menu-icon' }, '🧩'),
...
const menuOptions: MenuOption[] = [
  ...
  { key: 'password', label: '安全中心', icon: iconRenderers.password },
  {
    ...
    children: [
      ...
      { key: 'skill_management', label: '写作技能', icon: iconRenderers.skill_management },
